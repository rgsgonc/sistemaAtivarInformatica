    ...
    <div class="span12">
        <div class="widget-box">
            <div class="widget-title">
                ...
                <div class="buttons">
                    <a title="Icon Title" class="btn btn-mini btn-info" href="<?php echo base_url()?>index.php/os/editar/<?php echo $result->idOs?>"><i class="icon-pencil icon-white"></i> Editar</a>
